...
public class EntryController {
    ...
    @PostMapping(path = "/group-expense", consumes = MediaType.MULTIPART_FORM_DATA_VALUE, produces = MediaType.APPLICATION_JSON_VALUE)
    public ResponseEntity<EntryResponseDto> createGroupExpense(GroupExpenseCreateDto groupExpenseCreateDto) throws IOException {
        EntryResponseDto entryResponseDto = entryService.createGroupExpense(groupExpenseCreateDto);
